...
TEST_LABELS_PATH = os.path.join(args.annotations_path, "test_labels.pkl")
...
test_labels["file_path"] = test_labels["file_path"].map(replace_val)


pd.to_pickle(train_labels, os.path.join(args.annotations_path, 'new_train_labels.pkl'))
pd.to_pickle(val_labels, os.path.join(args.annotations_path, 'new_val_labels.pkl'))
pd.to_pickle(test_labels, os.path.join(args.annotations_path, 'new_test_labels.pkl'))
